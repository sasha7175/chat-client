...
// Modified for browser: uses window.LeoProfanityDict instead of require()
...
// Browser environment: load dictionary from window.LeoProfanityDict
if (typeof window !== 'undefined' && window.LeoProfanityDict) {
  LeoProfanity.wordDictionary = window.LeoProfanityDict;
  LeoProfanity.words = JSON.parse(JSON.stringify(LeoProfanity.wordDictionary['en']));
}
